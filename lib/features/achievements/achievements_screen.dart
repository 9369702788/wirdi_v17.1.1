              ...
              child: ListView(padding: EdgeInsets.fromLTRB(20, 20, 20, 20 + MediaQuery.of(context).padding.bottom),
                children: [
                  ...
                  Center(
                    child: Text(
                      Localizations.localeOf(context).languageCode == 'ar'
                          ? '\u0625\u062c\u0645\u0627\u0644\u064a \u0633\u062c\u062f\u0627\u062a \u0627\u0644\u062a\u0644\u0627\u0648\u0629: ${stats.lifetimeSajdaCount}'
                          : 'Total Sajda Tilawah: ${stats.lifetimeSajdaCount}',
                  ...
                  Center(
                    child: Text(
                      Localizations.localeOf(context).languageCode == 'ar'
                          ? 'أيام حماية السلسلة المتاحة: قراءة ${stats.wirdStreakFreezes} • حفظ ${stats.hifzStreakFreezes}'
                          : 'Streak freezes available: reading ${stats.wirdStreakFreezes} • hifz ${stats.hifzStreakFreezes}',
