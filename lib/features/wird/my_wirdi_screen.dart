                    ...
                    child: Column(
                      children: [
                        ...
                        ListTile(
                          ...
                          trailing: Text('${stats.azkarCompleted}/${MyWirdiStats.azkarSoftTarget}', style: const TextStyle(fontWeight: FontWeight.w700)),
                        ...
                        ListTile(
                          ...
                          trailing: Text('${stats.tasbeehTotal}/${MyWirdiStats.tasbeehSoftTarget}', style: const TextStyle(fontWeight: FontWeight.w700)),
